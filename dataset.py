...
def docred_convert_examples_to_features(
    ...
    ner_map = {'PAD':0, 'ORG':1, 'LOC':2, 'NUM':3, 'TIME':4, 'MISC':5, 'PER':6} #实体类别
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        if len(input_tokens) <= max_length - 2:
            ...
            input_ids = tokenizer.convert_tokens_to_ids(input_tokens)   #id-token转换
        ...
        structure_mask = numpy.zeros((5, max_length, max_length), dtype='float32')
